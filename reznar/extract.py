...
_SYSTEM = (
    ...
    "Set environment ONLY when the item names a specific terrain, location, or condition "
    "(e.g., 'underwater', 'forest', 'darkness', 'cold', 'desert', 'underground', 'daylight'). "
    "strong_in entries must be location/terrain/condition nouns — NEVER material adjectives "
    "(wooden, stone, iron, crystal) or creature types. If a description says 'in wooden structures' "
    "use the terrain type (dungeon, forest) not the material. Do NOT set environment when the item "
    "works in any environment, has no environment-specific behavior, or the description gives no named setting. "
    ...
    "Use the broadest applicable creature family, not a specific named creature. "
    "Generalize to the creature's parent category (e.g. an undead named creature → 'undead', "
    "a specific elemental creature → 'elemental', a specific dragon species → 'dragon'). "
